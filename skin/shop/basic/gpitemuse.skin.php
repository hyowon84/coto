...
<section id="sit_use_list">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++)
    {
        ...
        $is_href    = './gpitemuselist.php?bo_table=itemuse&amp;wr_id='.$row['wr_id'];
...
<?php
echo itemuse_page($config['cf_write_pages'], $page, $total_page, "./gpitemuse.php?gp_id=$gp_id&amp;page=", "");
?>

<div id="sit_use_wbtn">
    <a href="<?php echo $itemuse_form; ?>" class="btn02 itemuse_form">평가 남기기<span class="sound_only"> 새 창</span></a>
