...
<div id="sqa" style="background:#fff;">
	...
	<ul>
		...
		<li style="border:0px;float:right;">
			...
			<div class="date_diff">
				...
				<div class="date_diff_bn right <?if($date_diff == "12"){echo "on";}?>" idx="12">1년</div>
				<div style="border:0px;background:#fff;padding:0px 3px 0px 3px;">
					<input type="hidden" name="answer_month" value="<?=$answer_month?>">
					<select name="answer_status" style="height:26px;">
    ...
    <li style="padding:10px 0 10px 0;">
        ...
        <div class="sqa_img" style="margin:0 0 0 10px;">
...
$(function(){
	...
	$(".date_diff_bn").click(function(){
		...
		$("form[name='fsearch']").attr("action", "./itemqalist.php").submit();
	});
