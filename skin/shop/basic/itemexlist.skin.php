...
<div id="sqa_sch">
    ...
    <select name="sfl" required id="sfl">
        ...
        <option value="a.iq_subject" <?php echo get_selected($sfl, "a.is_subject"); ?>>오류제목</option>
        <option value="a.iq_question"<?php echo get_selected($sfl, "a.iq_question"); ?>>오류내용</option>
