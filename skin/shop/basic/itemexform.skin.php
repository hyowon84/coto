...
<div id="sit_qa_write" class="new_win">
    <h1 id="win_title">오류신고 쓰기</h1>

    <form name="fitemex" method="post" action="./itemexformupdate.php" onsubmit="return fitemex_submit(this);" autocomplete="off">
