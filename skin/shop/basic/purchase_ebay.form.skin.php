		...
		<div class="price_box">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr height="40px">
					...
					<td style="color:#545454;font-size:27px;font-weight:bold;text-align:right;"><font color="#ff5100"><?php echo number_format(getExchangeEbayRate($total));?></font><font color="#ff5100" style="font-size:20px;">원</font></td>
				</tr>
			</table>
		</div>
		<div class="frm_line"></div>
