...
<!-- 게시판 목록 시작 { -->
<div id="bo_list" style="width:<?php echo $width; ?>;margin:10px 0 0 0;">
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            <td class="td_subject">
                ...
                <a href="<?php echo $list[$i]['href'] ?>">
                    ...
                    <?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">댓글</span><span style="color:#e72f27;">[<?php echo $list[$i]['comment_cnt']; ?>]</span><span class="sound_only">개</span><?php } ?>
                </a>
...
<fieldset id="bo_sch">
    ...
    <select name="sfl" id="sfl" style="padding:5px 0;border:1px #e5e5e5 solid;">
