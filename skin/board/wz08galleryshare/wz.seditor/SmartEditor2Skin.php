<?php
	$bo_table = preg_match("/^[a-zA-Z0-9_]+$/", $_GET["bo_table"]) ? $_GET["bo_table"] : "";
	$doc_width = preg_match("/^[0-9]+$/", $_GET["doc_width"]) ? $_GET["doc_width"] : "";
?>
...
<script type="text/javascript" src="./js/hp_SE_MultiPhoto.js" charset="utf-8"> </script> 
<script type="text/javascript"> 
	var bo_table = "<?php echo $bo_table?>"; 
	var doc_width = "<?php echo $doc_width?>"; 
</script>
