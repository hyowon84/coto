...
<div style="width:500px;height:450px;background:#fff;margin:70px auto;">
...
<div id="mb_login" class="mbskin" style="padding:10px 0;">
    ...
    <div id="login_fs">
		...
		<div style="margin:10px 0 0 0;">
			...
			<div><input type="text" name="mb_id" id="login_id" required class="frm_input" value="아이디 @이메일주소"></div>
			<div style="margin:-6px 0 0 0;"><input type="password" name="mb_password" id="login_pw" required class="frm_input" value="비밀번호"></div>
	...
	<div style="margin:10px 0 0 0;text-align:center;">
		...
		<input type="image" src="<?=G5_URL?>/img/login_bn.gif" border="0" align="absmiddle">
		<!--<input type="submit" value="로그인" class="btn_submit">-->
	</div>

	<div style="margin:20px 0 0 0;text-align:center;color:#56ccc8;">
		<a href="<?php echo G5_BBS_URL ?>/password_lost.php" style="color:#56ccc8;">아이디 찾기</a> | <a href="<?php echo G5_BBS_URL ?>/password_lost.php" style="color:#56ccc8;">비밀번호 찾기</a> | <a href="<?=G5_URL?>/bbs/register.php" style="color:#56ccc8;">회원가입</a>
	</div>
