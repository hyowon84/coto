...
.bach72_thumb_subject {display:block;padding: 5px 0 !important;width:<?=$thumb_width?>px;;font-size:0.95em;height:50px;overflow:hidden;background:#223753}
    ...
    <div class="bach72_thumb" >
        ...
        <ul>
            ...
            <li<?=$li_class?> >
				...
				<div class="bach72_thumb_subject" style="background:#223753;color:#fff">
					<p style="font-size:12px;margin-left:25px;font-weight:bold;padding:3px 0 1px 0;font-style:italic;color:#56ccc8">Photo by <?=$mem_row[mb_nick]?></p>
					<p style="font-size:14px;margin-left:25px;width:350px;font-style:italic"><?=$list[$i]['subject'] ?></p>						
				</div>
				<div style="clear:both;position:relative">
					<a href="<?=G5_URL?>/bbs/board.php?bo_table=bestshot" >
