...
<form id="bid_form" name="bid_form" method="post" action="auction.bid.php">
	...
	<div class="ac_contents">
		...
		<h3>*경매관련안내</h3>
		<dl>
			<dd style="width:100%; font-size:1em; color:red; font-weight:bold;">경매상품은 판매가보다 저렴하게 낙찰 받아가실 수 있는 기회를 드리고 있다보니 상품의 상태가 완전한 최상급이 아닐 수도 있습니다. 또한 경매 상품은 교환, 환불이 어려우니 이 점 숙지하셔서 신중한 입찰을 부탁드리겠습니다.
				<br>* 경매 상품은 매주 목요일에만 배송됩니다. </dd>
		</dl>
