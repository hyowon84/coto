...
$store_slide_res = sql_query("select * from g5_store_slide order by no desc ");
...
$(document).ready(function(){
	...
	$(".store_slide_submit").click(function(){
		...
		$("form[name='fstoreslide']").attr("action", "./store_slide_update.php").submit();
