...
<div class="btn_add01 btn_add">
    <a href="./auction_form.php">상품등록</a>
    <a href="./auction_excel.php" onclick="return excelform(this.href);" target="_blank">상품일괄등록</a>
</div>

<form name="fitemlistupdate" method="post" action="./auction_listupdate.php" onsubmit="return fitemlist_submit(this);" autocomplete="off">
...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td rowspan="3" class="td_mng">
            ...
            <a href="./auction_copy.php?it_id=<?php echo $row['it_id']; ?>&amp;ca_id=<?php echo $row['ca_id']; ?>" class="itemcopy" target="_blank"><span class="sound_only"><?php echo htmlspecialchars2(cut_str($row['it_name'],250, "")); ?> </span>복사</a>
            <a href="./auction_form.php?w=u&amp;it_id=<?php echo $row['it_id']; ?>&amp;ca_id=<?php echo $row['ca_id']; ?>&amp;<?php echo $qstr; ?>"><span class="sound_only"><?php echo htmlspecialchars2(cut_str($row['it_name'],250, "")); ?> </span>수정</a>
