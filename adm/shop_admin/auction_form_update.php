...
$it_last_date = $it_last_date1.$it_last_date2.$it_last_date3."235959";

$sql_common = " ca_id               = '1040',
                ca_id2              = '$ca_id2',
                ca_id3              = '$ca_id3',
...
<script>
    if (confirm("계속 입력하시겠습니까?"))
        //location.href = "<?php echo "./auction_form.php?it_id=$it_id&amp;sort1=$sort1&amp;sort2=$sort2&amp;sel_ca_id=$sel_ca_id&amp;sel_field=$sel_field&amp;search=$search&amp;page=$page"?>";
        location.href = "<?php echo "./auction_form.php?$qstr"; ?>";
    else
        location.href = "<?php echo "./auction_list.php?$qstr"; ?>";
</script>
