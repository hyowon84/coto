...
for ($i=0; $i<count($_POST['chk']); $i++)
{
    ...
    switch ($current_status)
    {
        ...
        case '배송중' :
            ...
            change_status($od_id, '배송중', '배송완료');

            // 배송완료인 경우에만 상품구입 합계수량을 상품테이블에 저장한다.
            $sql2 = " select it_id, sum(ct_qty) as sum_qty from {$g5['g5_shop_cart_table']} where od_id = '$od_id' and ct_status = '배송완료' group by it_id ";
...
goto_url("./orderlist_wait.php?$qstr");
?>