...
if (!function_exists("itemdelete")) {
    ...
    function itemdelete($it_id)
    {
        ...
        // 상품문의삭제
        $sql = " delete from g5_shop_gpitem_qa where gp_id = '$gp_id' ";
        sql_query($sql);
		...
		$sql = " delete from {$g5['g5_shop_option1_table']} where it_id = '$it_id' ";
		sql_query($sql);

		$sql = " delete from {$g5['g5_shop_option2_table']} where it_id = '$it_id' ";
		sql_query($sql);
    }
}
