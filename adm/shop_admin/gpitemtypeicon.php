...
$item_type_res = sql_query("select * from {$g5['g5_gp_item_type_icon_table']} order by no desc ");
?>
...
<section id="scp_list">
	...
	<form name="fitemtype" id="fitemtype" method="post" enctype="multipart/form-data" action="gpitemtypeicon_update.php">
    ...
    <div class="btn_list01 btn_list">
        ...
        <input type="submit" value="이미지 등록" style="padding:5px;height:32px;" class="item_type_submit">
    </div>
	</form>
	...
	$(".btn").click(function(){
		...
		if(mode == "del"){
			...
			if(confirm("수정하시겠습니까?")){
				...
				$("form[name='fitemtypemodify']").attr("action", "./gpitemtypeicon_update.php").submit();
			}
		}
	});
