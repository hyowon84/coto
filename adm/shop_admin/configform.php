...
<section id ="anc_scf_payment">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <textarea name="de_bank_account" id="de_bank_account"><?php echo $default['de_bank_account']; ?></textarea></br>
				<font>1</font>
            </td>
        </tr>
        <tr>
...
<section id="anc_scf_delivery">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row">배송정보(공동구매)</th>
            <td><?php echo editor_html('de_gpbaesong_content', $default['de_gpbaesong_content']); ?></td>
        </tr>
        <tr>
...
<section id="anc_scf_etc">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="de_deposit_keep_term">입금대기기간</label></th>
            <td>
                 <?php echo help("입금대기 상품의 보관 기간을 설정하십시오."); ?>
                <input type="text" name="de_deposit_keep_term" value="<?php echo $default['de_deposit_keep_term']; ?>" id="de_deposit_keep_term" class="frm_input" size="5"> 일
            </td>
        </tr>
