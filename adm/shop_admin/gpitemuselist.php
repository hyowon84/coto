...
$sql_common = "  from g5_shop_gpitem_use a
                 left join {$g5['g5_shop_group_purchase_table']} b on (a.gp_id = b.gp_id)
...
<form name="fitemuselist" method="post" action="./gpitemuselistupdate.php" onsubmit="return fitemuselist_submit(this);" autocomplete="off">
...
<div class="tbl_head01 tbl_wrap">
    ...
    for ($i=0; $row=sql_fetch_array($result); $i++) {
        ...
        $href = G5_SHOP_URL.'/gpitem.php?it_id='.$row['it_id'];
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_mngsmall">
            <a href="./gpitemuseform.php?w=u&amp;is_id=<?php echo $row['is_id']; ?>&amp;<?php echo $qstr; ?>"><span class="sound_only"><?php echo $row['is_subject']; ?> </span>수정</a>
        </td>
    </tr>
