...
function change_admin_status($od_id, $change_status)
{
    global $g5;
...
function order_update_receipt($od_id)
{
    ...
    $sql = " update {$g5['g5_shop_order_table']} set od_receipt_price = od_misu, od_misu = 0, od_receipt_time = '".G5_TIME_YMDHIS."' where od_id = '$od_id' and od_status = '결제완료' ";
    return sql_query($sql);
}
...
function order_update_delivery($od_id, $mb_id, $change_status, $delivery)
{
    ...
    $sql = " update {$g5['g5_shop_order_table']} set od_delivery_company = '{$delivery['delivery_company']}', od_invoice = '{$delivery['invoice']}', od_invoice_time = '{$delivery['invoice_time']}' where od_id = '$od_id' and od_status = '상품준비중' ";
    sql_query($sql);
