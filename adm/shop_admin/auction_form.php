...
$frm_submit = '<div class="btn_confirm01 btn_confirm">
    <a href="'.G5_SHOP_URL.'/auction.php?it_id='.$it_id.'" class="btn_frmline">상품확인</a>
    <input type="submit" value="확인" class="btn_submit" accesskey="s">
    <a href="./itemlist.php?'.$qstr.'">목록</a>
</div>';
?>

<form name="fitemform" action="./auction_form_update.php" method="post" enctype="MULTIPART/FORM-DATA" autocomplete="off" onsubmit="return fitemformcheck(this)">
...
<section id="anc_sitfrm_ini">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
			...
			<?php }?>
			</select> /  <input type="text" name="it_metal_don" value="<?php echo $it['it_metal_don']; ?>" id="it_metal_don" required class="required frm_input" size="5"> 돈
            </td>
        </tr>
...
<section id="anc_sitfrm_cost">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tr>
            ...
            <td>
                <input type="text" name="it_price" value="<?php echo $it['it_price']; ?>" id="it_price" class="frm_input" size="8"> 원 <input type="radio" name="it_price_type" value="N" <?php if($it[it_price_type]=="N")echo "checked";?>> 고정형
				 <input type="radio" name="it_price_type" value="Y" <?php if($it[it_price_type]=="Y")echo "checked";?>> 실시간
            </td>
            <td class="td_grpset">
            ...
            <tr id="sc_con_basic">
                ...
                <td>
                    <?php echo help("무료배송 이외의 설정에 적용되는 배송비 금액입니다."); ?>
                     <input type="text" name="it_sc_price" value="<?php echo $it['it_sc_price']; ?>" id="it_sc_price" class="frm_input" size="4"> 원
                </td>
            </tr>
