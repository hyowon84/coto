...
$sql_common = "  from {$g5['g5_shop_gpitem_qa_table']} a
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td><a href="<?php echo $href; ?>"><?php echo get_gp_image($row['gp_id'], 50, 50); ?> <?php echo cut_str($row['gp_name'],30); ?></a></td>
        <td>
        ...
        <td class="td_mngsmall">
            <a href="./gpitemqaform.php?w=u&amp;iq_id=<?php echo $row['iq_id']; ?>&amp;<?php echo $qstr; ?>"><span class="sound_only"><?php echo $row['iq_subject']; ?> </span>수정</a>
        </td>
    </tr>
    <?php
    }
