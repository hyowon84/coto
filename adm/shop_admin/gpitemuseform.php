...
$sql = " select *
           from g5_shop_gpitem_use a
           left join {$g5['member_table']} b on (a.mb_id = b.mb_id)
           left join {$g5['g5_shop_group_purchase_table']} c on (a.gp_id = c.gp_id)
          where is_id = '$is_id' ";
$is = sql_fetch($sql);
if (!$is['is_id'])
    alert('등록된 자료가 없습니다.');
...
<form name="fitemuseform" method="post" action="./gpitemuseformupdate.php" onsubmit="return fitemuseform_submit(this);">
<input type="hidden" name="w" value="<?php echo $w; ?>">
<input type="hidden" name="is_id" value="<?php echo $is_id; ?>">
<input type="hidden" name="gp_id" value="<?php echo $is['is_id']; ?>">
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row">상품명</th>
        <td><a href="<?php echo G5_SHOP_URL; ?>/gpitem.php?it_id=<?php echo $is['gp_id']; ?>"><?php echo $is['gp_name']; ?></a></td>
    </tr>
    <tr>
        <th scope="row">이름</th>
        <td><?php echo $name; ?></td>
...
<div class="btn_confirm01 btn_confirm">
    ...
    <a href="./gpitemuselist.php?<?php echo $qstr; ?>">목록</a>
</div>
</form>
