...
<section id="anc_sodr_list">
    ...
    <div class="local_desc02 local_desc">
        <p>
            ...
            |
            주문일시 <strong><?php echo $od['od_time']; ?> (<?php echo get_yoil($od['od_time']); ?>)</strong>
            |
        ...
        for($i=0; $row=sql_fetch_array($result); $i++) {
            ...
            <tr>
				...
				<td rowspan="<?php echo $rowspan; ?>">
                    <a href="./grouppurchaseform.php?w=u&amp;gp_id=<?php echo $row['it_id']; ?>">공동구매</a>
                </td>
                <td rowspan="<?php echo $rowspan; ?>">
                    <a href="./grouppurchaseform.php?w=u&amp;gp_id=<?php echo $row['it_id']; ?>"><?php echo $image; ?> <?php echo stripslashes($row['it_name']); ?></a>
                </td>
				<?php }else{?>
				<td rowspan="<?php echo $rowspan; ?>">
                    <a href="./itemform.php?w=u&amp;it_id=<?php echo $row['it_id']; ?>">일반구매</a>
                </td>
                <td rowspan="<?php echo $rowspan; ?>">
    ...
    <div class="btn_list02 btn_list">
        <p>
			...
			<input type="submit" name="ct_status" value="배송대기" onclick="document.pressed=this.value">
			...
			<input type="submit" name="ct_status" value="교환" onclick="document.pressed=this.value">
    ...
    <div class="local_desc01 local_desc">
        <p>입금대기, 결제완료, 상품준비중, 배송중, 배송완료는 장바구니와 주문서 상태를 모두 변경하지만, 취소, 교환, 반품, 품절은 장바구니의 상태만 변경하며, 주문서 상태는 변경하지 않습니다.</p>
...
<section class="">
            ...
            <div class="tbl_frm01">
                ...
                <tr>
                    ...
                    <td>
						...
						<?}else{?>
							<?php echo $html_receipt_chk; ?>
							<input type="text" name="od_receipt_price" value="<?php echo $od['od_misu']; ?>" id="od_receipt_price" class="frm_input"> 원
						<?}?>
                    </td>
                </tr>
                <tr>
    ...
    <div class="btn_confirm01 btn_confirm">
        ...
        <?php if($od['od_status'] == '입금대기' && $od['od_misu'] > 0) { ?>
...
function chk_receipt_price()
{
	...
	price.value = chk.checked ? (parseInt(chk.value)) : price.defaultValue;
}
</script>
