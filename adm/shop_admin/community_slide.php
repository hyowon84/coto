...
$community_slide_res = sql_query("select * from {$g5['g5_community_slide_table']} order by no desc ");
...
<section id="scp_list">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php echo $bg; ?> del<?=$community_slide_row[no]?>">
			...
			<td width="7%">
				<?
				if($community_slide_row[status] == "community"){
					echo "커뮤니티";
				}else{
					echo "갤러리";
				}
    ...
    <div class="btn_list01 btn_list">
		<select name="community_status" style="padding:5px;height:32px;">
			...
			<option value="community_gall">갤러리</option>
		</select>
