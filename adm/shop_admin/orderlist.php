...
?>
    ...
    if ($od_status == '배송대기') $change_status = "배송중";
...
<p>
    ...
    &lt;배송대기&gt;에서 &lt;배송중&gt;으로 변경시 &lt;에스크로배송등록&gt;을 체크하시면 에스크로 주문에 한해 KCP에 배송정보가 자동 등록됩니다.<br>
...
$(function(){
	...
	$(".order_excel").click(function(){
		$("form[name='frmorderlist']").attr("action", "./orderlist_excel.php").submit();
	});
