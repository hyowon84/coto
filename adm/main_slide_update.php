...
if($_POST[mode] == "w"){
	...
	goto_url("main_slide.php", "등록이 완료 되었습니다.");

}else if($_POST[mode] == "u"){

	
	if($_FILES[img_file][name]){
		$del_img = sql_fetch("select * from g5_main_slide where no='$no' ");
	...
	goto_url("main_slide.php", "수정이 완료 되었습니다.");
	...
	sql_query("delete from g5_main_slide where no='$no' ");

	alert("삭제가 완료 되었습니다.","main_slide.php");
