...
$it_bid = $_POST[it_bid];
$it_last_date_y = $_POST[it_last_date_y];
$it_last_date_m = $_POST[it_last_date_m];
$it_last_date_d = $_POST[it_last_date_d];


if($it_type == "3") $it_type3 = "1";
if($it_type == "4") $it_type4 = "1";
if($it_type == "5") $it_type5 = "1";
if($it_type == "6") $it_type6 = "1";
...
$it_status = $_POST[item_status];

if($_POST[it_price_type] == "A"){
	$it_bid = strip_tags(trim($_POST['it_bid']));
	$it_last_date1 = strip_tags(trim($_POST['it_last_date1']));
	$it_last_date2 = strip_tags(trim($_POST['it_last_date2']));
	$it_last_date3 = strip_tags(trim($_POST['it_last_date3']));
	$it_last_date4 = strip_tags(trim($_POST['it_last_date4']));
	$it_last_date5 = strip_tags(trim($_POST['it_last_date5']));
	$it_last_date6 = strip_tags(trim($_POST['it_last_date6']));

	if($it_last_date2 < 10){
		$it_last_date2 = "0".$it_last_date2;
	}else{
		$it_last_date2 = $it_last_date2;
	}

	if($it_last_date3 < 10){
		$it_last_date3 = "0".$it_last_date3;
	}else{
		$it_last_date3 = $it_last_date3;
	}

	if($it_last_date4 < 10){
		$it_last_date4 = "0".$it_last_date4;
	}else{
		$it_last_date4 = $it_last_date4;
	}

	if($it_last_date5 < 10){
		$it_last_date5 = "0".$it_last_date5;
	}else{
		$it_last_date5 = $it_last_date5;
	}

	if($it_last_date6 < 10){
		$it_last_date6 = "0".$it_last_date6;
	}else{
		$it_last_date6 = $it_last_date6;
	}

	$it_last_date = $it_last_date1.$it_last_date2.$it_last_date3.$it_last_date4.$it_last_date5.$it_last_date6;
}

$sql_common = " ca_id               = '$ca_id',
                ca_id2              = '$ca_id2',
                ca_id3              = '$ca_id3',
				it_metal_type       = '$it_metal_type',
                it_metal_don		= '$it_metal_don',
                it_name             = '$it_name',
                ...
                it_complete_price       = '$it_complete_price',
                ...
                it_metal_etc_price       = '$it_metal_etc_price',
                it_real_add_price       = '$it_real_add_price',
                it_real_add_unit       = '$it_real_add_unit',
				it_real_url		=	'$it_real_url',
                it_img1             = '$it_img1',
                it_img2             = '$it_img2',
                it_img3             = '$it_img3',
                it_img4             = '$it_img4',
                ...
                it_9                = '$it_9',
                it_10               = '$it_10',
				it_last_date        = '$it_last_date',
				it_bid              = '$it_bid',
				auc_status          = '$it_status',
				it_year				= '$it_year',
				it_cnt				= '$it_cnt',
				it_type				= '$it_type'
                ";
...
if(is_checked('chk_ca_it_complete_price'))          $ca_fields .= " , it_complete_price = '$it_complete_price' ";
...
if(is_checked('chk_all_it_complete_price'))          $all_fields .= " , it_complete_price = '$it_complete_price' ";
...
sql_query("delete from {$g5['g5_shop_option1_table']} where it_id='".$it_id."' ");
sql_query("delete from {$g5['g5_shop_option2_table']} where it_id='".$it_id."' ");

for($i = 0; $i < count($_POST[it_op_title]); $i++){
	if($_POST[it_op_title][$i]){
		$sql = "
			insert into {$g5['g5_shop_option1_table']} set
			gubun='N',
			con='".$_POST[it_op_title][$i]."',
			it_id='".$it_id."'
		";
		//echo $sql."</br>";
		sql_query($sql);
		...
		for($j = 0; $j < count($_POST["it_op_name".$i]); $j++){
			$_POST["it_op_name".$i][$j] = $_POST["it_op_name".$i][$j];
			$_POST["it_op_price".$i][$j] = $_POST["it_op_price".$i][$j];
			$sql1 = "
				insert into {$g5['g5_shop_option2_table']} set
				num='".$num."',
				con='".$_POST["it_op_name".$i][$j]."',
				price='".$_POST["it_op_price".$i][$j]."',
				it_id='".$it_id."'
			";
			//echo $sql1."</br>";
			sql_query($sql1);
