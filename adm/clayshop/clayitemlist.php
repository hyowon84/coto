...
$sql_common .= "WHERE		(( a.ca_id = b.ca_id AND	a.it_id LIKE 'cllay%'	)
								OR			( a.ca_id = b.ca_id AND	a.it_id LIKE 'cafe%'	
								))
";
...
<div class="btn_add01 btn_add">
	...
	<a href="./itemexceldownload.php?<?php echo $qstr?>">상품다운로드</a>
...
<div class="tbl_head02 tbl_wrap">
    ...
    <tr>
		...
		<th scope="col" rowspan="2" id="th_img">구분</th>
    ...
    <tr class="<?php echo $bg; ?>">
		...
		<td rowspan="2" class="td_img"><?php echo $auc_status;?></td>
