...
$pg_anchor = '<ul class="anchor">
	...
	<li><a href="#anc_cf_pay">주문결제</a></li>
...
<section id="anc_cf_join">
    ...
    <div class="tbl_frm01 tbl_wrap">
		...
		<tr>
            <th scope="row"><label for="cf_dc">코인즈투데이특약</label></th>
            <td colspan="3"><textarea id="cf_dc" name="cf_dc" rows="10"><?php echo $config['cf_dc'] ?></textarea></td>
        </tr>
        </tbody>
        </table>
    </div>
...
<section id="anc_cf_pay">
    <h2 class="h2_frm">주문결제 설정</h2>
    <?php echo $pg_anchor ?>
    <div class="local_desc02 local_desc">
        <p>주문 시 개인정보 제3자 제공 및 주의사항과</br>
		결제대행서비스 표준이용약관 내용을 설정할 수 있습니다.</p>
    </div>

    <div class="tbl_frm01 tbl_wrap">
        <table>
        <caption>주문결제 설정</caption>
        <colgroup>
            <col class="grid_4">
            <col>
            <col class="grid_4">
        ...
        <tr>
            <th scope="row"><label for="cf_pay_aree1">개인정보 제3자 제공</label></th>
            <td colspan="3"><textarea id="cf_pay_aree1" name="cf_pay_aree1" rows="10"><?php echo $config['cf_pay_aree1'] ?></textarea></td>
        </tr>

		<tr>
            <th scope="row"><label for="cf_pay_aree2">주의사항</label></th>
            <td colspan="3"><textarea id="cf_pay_aree2" name="cf_pay_aree2" rows="10"><?php echo $config['cf_pay_aree2'] ?></textarea></td>
        </tr>

		<tr>
            <th scope="row"><label for="cf_pay_aree3">기본약관</label></th>
            <td colspan="3"><textarea id="cf_pay_aree3" name="cf_pay_aree3" rows="10"><?php echo $config['cf_pay_aree3'] ?></textarea></td>
        </tr>

		<tr>
            <th scope="row"><label for="cf_pay_aree4">개인정보 수집, 이용</label></th>
            <td colspan="3"><textarea id="cf_pay_aree4" name="cf_pay_aree4" rows="10"><?php echo $config['cf_pay_aree4'] ?></textarea></td>
        </tr>

		<tr>
            <th scope="row"><label for="cf_pay_aree5">개인정보 제공, 위탁</label></th>
            <td colspan="3"><textarea id="cf_pay_aree5" name="cf_pay_aree5" rows="10"><?php echo $config['cf_pay_aree5'] ?></textarea></td>
        </tr>
