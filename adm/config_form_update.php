...
$sql = " update {$g5['config_table']}
            set cf_title = '{$_POST['cf_title']}',
                ...
                cf_9 = '{$_POST['cf_9']}',
                cf_10 = '{$_POST['cf_10']}',
				cf_pay_aree1 = '{$_POST['cf_pay_aree1']}',
				cf_pay_aree2 = '{$_POST['cf_pay_aree2']}',
				cf_pay_aree3 = '{$_POST['cf_pay_aree3']}',
				cf_pay_aree4 = '{$_POST['cf_pay_aree4']}',
				cf_pay_aree5 = '{$_POST['cf_pay_aree5']}',
				cf_dc = '{$_POST['cf_dc']}'
				";
sql_query($sql);
