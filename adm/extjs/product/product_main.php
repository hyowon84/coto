...
<!-- 모델 데이터 -->
<script type="text/javascript" src="model/product_main.model.js"></script>

<!-- 스토어 데이터 -->
<script type="text/javascript" src="store/product_main.store.js"></script>

<!-- 공통 콤보박스 정의 -->
<script type="text/javascript" src="view/combo/product.common.js"></script>


<!-- 그리드 -->
<script type="text/javascript" src="view/grid/product_main.grid.js"></script>

<!-- 패널 -->
<script type="text/javascript" src="view/panel/product_main.panel.js"></script>

<!-- 윈도우팝업 -->
<script type="text/javascript" src="view/window/product_main.window.js"></script>

<!-- 패널 -->
<script type="text/javascript" src="view/product_main.js"></script>
