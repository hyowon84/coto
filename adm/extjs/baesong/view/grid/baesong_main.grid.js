			...
			listeners:{
				keydown:function(t,e){
					if(e.keyCode == 13){
						...
						grid_shiped_list.store.loadData([],false);
						Ext.apply(grid_shiped_list.store.getProxy().extraParams, params);
						Ext.getCmp('ptb_shiped_list').moveFirst();
					}
				}
			}
		},*/
