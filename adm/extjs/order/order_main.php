...
<!-- 모델 데이터 -->
<script type="text/javascript" src="model/order_main.model.js"></script>

<!-- 스토어 데이터 -->
<script type="text/javascript" src="../bank/store/bank_main.store.js"></script>
<script type="text/javascript" src="../bank/view/grid/bank_main.grid.js"></script>


<!-- 그리드 -->
<script type="text/javascript" src="store/order_main.store.js"></script>
<script type="text/javascript" src="view/grid/order_main.grid.js"></script>

<!-- 패널 -->
<script type="text/javascript" src="view/panel/order_main.panel.js"></script>

<!-- 윈도우팝업 -->
<script type="text/javascript" src="view/window/order_main.window.js"></script>

<!-- 시작패널 -->
<script type="text/javascript" src="view/order_main.js"></script>
