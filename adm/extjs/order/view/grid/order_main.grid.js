...
var grid_orderlist = Ext.create('Ext.grid.Panel',{
	...
	columns	: [
		...
		{ text: '주문상태', 			dataIndex: 'stats',									width: 140,		editor: Ext.create('Ext.combobox.order.stats'),		renderer: rendererCombo	},
		{ text: '개별송장번호',	dataIndex: 'delivery_invoice',			width: 120,		style:'text-align:center'	},
		{ text: '현금처리번호',	dataIndex: 'cash_receipt_info',			width: 120,		style:'text-align:center'	},
