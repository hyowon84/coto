...
$where[] = " od_id in ( select distinct od_id from $g5[g5_shop_cart_table] where ct_gubun='P' and re_status='y' ) ";
$where[] = " od_status!='반품' and od_status!='교환' ";
...
$(function(){
	...
	$(".order_modify").click(function(){
		...
		if(confirm("선택하신 항목을 수정하시겠습니까?")){
			...
			$("form[name='forderlist']").attr({"action":"./orderlist_return_appli_update.php"}).submit();
		}
	});
});
