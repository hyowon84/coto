...
<div class="local_ov01 local_ov">
    ...
    <?php if($od_status == '해외배송대기' && $total_count > 0) { ?>
...
?>
	...
	if ($od_status == '결재완료') $change_status = "해외배송대기";
	if ($od_status == '해외배송대기') $change_status = "해외배송중";
    if ($od_status == '해외배송중') $change_status = "상품준비중";
...
$(function(){
	...
	$(".order_modify").click(function(){
		...
		if(confirm("선택하신 항목을 수정하시겠습니까?")){
			...
			$("form[name='forderlist']").attr({"action":"./orderlist_deli_wait1_en_update.php"}).submit();
		}
	});
});
