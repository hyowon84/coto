...
if ($od_status) {
    switch($od_status) {
        case '전체취소':
            ...
            break;
        case '부분취소':
            $where[] = " od_status IN('입금대기', '결제완료', '상품준비중', '배송대기', '해외배송대기', '배송중', '배송완료') and od_cancel_price > 0 ";
            break;
        default:
...
$(function(){
	...
	$(".order_excel").click(function(){
		$("form[name='frmorderlist']").attr("action", "./orderlist_combine_deli_appli_excel.php").submit();
	});
});
