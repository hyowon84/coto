...
<div style="margin:0 0 10px 20px;">
	...
	<div class="order_modify" idx="1" style="display:inline-block;padding:10px;border:1px solid #ccc;background:#f0f0f0;text-decoration:none;cursor:pointer">선택변경</div>
</div>
...
$(function(){
	...
	$(".order_modify").click(function(){
		...
		if(confirm("선택하신 항목을 수정하시겠습니까?")){
			...
			$("form[name='forderlist']").attr({"action":"./orderlist_cancel_appli_update.php"}).submit();
		}
	});
});
