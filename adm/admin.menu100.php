...
$menu['menu100'] = array (
    ...
    array('100800', '세션파일 일괄삭제',G5_ADMIN_URL.'/session_file_delete.php', 'cf_session'),
    array('100900', '캐시파일 일괄삭제',G5_ADMIN_URL.'/cache_file_delete.php',   'cf_cache'),
    array('100920', '썸네일파일 일괄삭제',G5_ADMIN_URL.'/thumbnail_file_delete.php', 'cf_thumbnail'),
    array('100930', '네이버 신디케이션 핑',G5_SYNDI_URL.'/ping.php',   'cf_syndi_ping'),
