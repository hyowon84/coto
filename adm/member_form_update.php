...
if($_POST['mb_id2'])$mb_id          = $mb_id."@".escape_trim($_POST['mb_id2']);

if($_POST[mb_birth2] < 10)
	$mb_birth2 = "0".$_POST[mb_birth2];
else
	$mb_birth2 = $_POST[mb_birth2];

if($_POST[mb_birth3] < 10)
	$mb_birth3 = "0".$_POST[mb_birth3];
else
	$mb_birth3 = $_POST[mb_birth3];

$mb_birth       = $_POST[mb_birth1].$mb_birth2.$mb_birth3;
