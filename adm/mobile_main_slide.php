...
$sql_common = " from g5_mobile_main_slide ";
...
<div class="btn_add01 btn_add">
    <a href="./mobile_main_slide_write.php" id="main_slide_add">등록</a>
</div>
<?php } ?>

<form name="fmain_slide" id="fmain_slide" action="./mobile_main_slide_listupdate.php" method="post">
...
$(document).ready(function(){
	$(".modify").click(function(){
		var no = $(this).attr("no");
		location.href = "./mobile_main_slide_write.php?no=" + no;
	});
	...
	$(".del").click(function(){
		...
		$("form[name='fmain_slide']").attr("action", "./mobile_main_slide_update.php").submit();
		}
	});
