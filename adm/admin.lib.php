...
else if ($is_admin != 'super')
{
    ...
    if (!$i && $member[mb_id] != 'facebook77@naver.com')
    {
...
$tmp = dir(G5_ADMIN_PATH);
	...
	while ($entry = $tmp->read()) {
	    ...
	    $amenu[$m[1]] = $entry;
		if(strpos($entry, "sub") === false){
			include_once(G5_ADMIN_PATH.'/'.$entry);
		}
	}

//코투 관리자
if($member[mb_id] != 'bin4209@nts.go.kr') {

}
//예외 관계자
else {
// 	$amenu[200] = 'admin.menu200.php';
// 	include_once(G5_ADMIN_PATH.'/admin.menu200.php');

// 	$amenu[400] = 'admin.menu400.php';
// 	include_once(G5_ADMIN_PATH.'/admin.menu400.php');
}
