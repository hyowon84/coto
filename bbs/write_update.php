...
if($bo_table == "event"){
	if($_POST[wr_4_2] < 10){
		$wr_4_2 = "0".$_POST[wr_4_2];
	}
	if($_POST[wr_4_3] < 10){
		$wr_4_3 = "0".$_POST[wr_4_3];
	}

	if($_POST[wr_5_2] < 10){
		$wr_5_2 = "0".$_POST[wr_5_2];
	}
	if($_POST[wr_5_3] < 10){
		$wr_5_3 = "0".$_POST[wr_5_3];
	}
	$wr_4 = $_POST[wr_4_1]."-".$wr_4_2."-".$wr_4_3;
	$wr_5 = $_POST[wr_5_1]."-".$wr_5_2."-".$wr_5_3;
}
