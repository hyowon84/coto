...
if ($w == 'c') // 댓글 입력
{
    ...
    */
	...
	if($bo_table == "photo_gallery"){
		...
		$photo_gall_row = sql_fetch("select * from {$g5['g5_write_photo_gallery_table']} where wr_id='".$comment_id."' ");
		$sql = " insert into {$g5['g5_write_bestshot_table']}
					set ca_name = '".$photo_gall_row[ca_name]."',
						 wr_option = '".$photo_gall_row[wr_option]."',
						 wr_num = '".$photo_gall_row[wr_num]."',
						 wr_reply = '".$photo_gall_row[wr_reply]."',
						 wr_parent = '".$photo_gall_row[wr_parent]."',
						 wr_is_comment = '".$photo_gall_row[wr_is_comment]."',
						 wr_comment = '".$photo_gall_row[wr_comment]."',
						 wr_comment_reply = '".$photo_gall_row[wr_comment_reply]."',
						 wr_subject = '".$photo_gall_row[wr_subject]."',
						 wr_content = '".$photo_gall_row[wr_content]."',
						 mb_id = '".$photo_gall_row[mb_id]."',
						 wr_password = '".$photo_gall_row[wr_password]."',
						 wr_name = '".$photo_gall_row[wr_name]."',
						 wr_email = '".$photo_gall_row[wr_email]."',
						 wr_homepage = '".$photo_gall_row[wr_homepage]."',
						 wr_datetime = '".$photo_gall_row[wr_datetime]."',
						 wr_last = '".$photo_gall_row[wr_last]."',
						 wr_ip = '".$photo_gall_row[wr_ip]."',
						 wr_facebook_user = '".$photo_gall_row[wr_facebook_user]."',
						 wr_twitter_user  = '".$photo_gall_row[wr_twitter_user]."',
						 wr_1 = '".$photo_gall_row[wr_1]."',
						 wr_2 = '".$photo_gall_row[wr_2]."',
						 wr_3 = '".$photo_gall_row[wr_3]."',
						 wr_4 = '".$photo_gall_row[wr_4]."',
						 wr_5 = '".$photo_gall_row[wr_5]."',
						 wr_6 = '".$photo_gall_row[wr_6]."',
						 wr_7 = '".$photo_gall_row[wr_7]."',
						 wr_8 = '".$photo_gall_row[wr_8]."',
						 wr_9 = '".$photo_gall_row[wr_9]."',
						 wr_10 = '".$photo_gall_row[wr_10]."' ";

		sql_query($sql);

		
	}else if($bo_table == "bestshot"){

		$bestshot_row = sql_fetch("select * from {$g5['g5_write_bestshot_table']} where wr_id='".$comment_id."' ");
		$sql = " insert into {$g5['g5_write_photo_gallery_table']}
					set ca_name = '".$bestshot_row[ca_name]."',
						 wr_option = '".$bestshot_row[wr_option]."',
						 wr_num = '".$bestshot_row[wr_num]."',
						 wr_reply = '".$bestshot_row[wr_reply]."',
						 wr_parent = '".$bestshot_row[wr_parent]."',
						 wr_is_comment = '".$bestshot_row[wr_is_comment]."',
						 wr_comment = '".$bestshot_row[wr_comment]."',
						 wr_comment_reply = '".$bestshot_row[wr_comment_reply]."',
						 wr_subject = '".$bestshot_row[wr_subject]."',
						 wr_content = '".$bestshot_row[wr_content]."',
						 mb_id = '".$bestshot_row[mb_id]."',
						 wr_password = '".$bestshot_row[wr_password]."',
						 wr_name = '".$bestshot_row[wr_name]."',
						 wr_email = '".$bestshot_row[wr_email]."',
						 wr_homepage = '".$bestshot_row[wr_homepage]."',
						 wr_datetime = '".$bestshot_row[wr_datetime]."',
						 wr_last = '".$bestshot_row[wr_last]."',
						 wr_ip = '".$bestshot_row[wr_ip]."',
						 wr_facebook_user = '".$bestshot_row[wr_facebook_user]."',
						 wr_twitter_user  = '".$bestshot_row[wr_twitter_user]."',
						 wr_1 = '".$bestshot_row[wr_1]."',
						 wr_2 = '".$bestshot_row[wr_2]."',
						 wr_3 = '".$bestshot_row[wr_3]."',
						 wr_4 = '".$bestshot_row[wr_4]."',
						 wr_5 = '".$bestshot_row[wr_5]."',
						 wr_6 = '".$bestshot_row[wr_6]."',
						 wr_7 = '".$bestshot_row[wr_7]."',
						 wr_8 = '".$bestshot_row[wr_8]."',
						 wr_9 = '".$bestshot_row[wr_9]."',
						 wr_10 = '".$bestshot_row[wr_10]."' ";
		sql_query($sql);
	}
...
else if ($w == 'cu') // 댓글 수정
{
	...
	if($bo_table == "photo_gallery"){
		...
		$photo_gall_row = sql_fetch("select * from {$g5['g5_write_photo_gallery_table']} where wr_id='".$comment_id."' ");
		$sql = " update {$g5['g5_write_bestshot_table']}
					set wr_subject = '".$photo_gall_row[wr_subject]."',
						 wr_content = '".$photo_gall_row[wr_content]."',
						 wr_1 = '".$photo_gall_row[wr_1]."',
						 wr_2 = '".$photo_gall_row[wr_2]."',
						 wr_3 = '".$photo_gall_row[wr_3]."',
						 ...
						 $sql_ip
						 $sql_secret
				  where wr_parent = '".$photo_gall_row[wr_parent]."' and wr_comment='".$photo_gall_row[wr_comment]."' and wr_comment_reply='".$photo_gall_row[wr_comment_reply]."' ";
		...
		$bestshot_row = sql_fetch("select * from {$g5['g5_write_bestshot_table']} where wr_id='".$comment_id."' ");
		$sql = " update {$g5['g5_write_photo_gallery_table']}
					set wr_subject = '".$bestshot_row[wr_subject]."',
						 wr_content = '".$bestshot_row[wr_content]."',
						 wr_1 = '".$bestshot_row[wr_1]."',
						 wr_2 = '".$bestshot_row[wr_2]."',
						 wr_3 = '".$bestshot_row[wr_3]."',
						 ...
						 $sql_ip
						 $sql_secret
				  where wr_parent = '".$bestshot_row[wr_parent]."' and wr_comment='".$bestshot_row[wr_comment]."' and wr_comment_reply='".$bestshot_row[wr_comment_reply]."' ";
