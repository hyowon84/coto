...
<div id="idpw_chk" class="mbskin">
	...
	<div class="box">
		<div class="title">
			<ul>
				<li onclick="goto_url('./password_lost_id.php');">아이디 찾기</li>
				<li class="on" onclick="goto_url('./password_lost.php');">비밀번호 찾기</li>
			</ul>
		</div>
		...
		<div class="sub_box id_find">
			<ul>
				<li>
					<span class="title">본인 확인 후 찾기</span>
					<div class="des">
						실명이 확인된 아이디는 휴대폰으로 비밀번호를 찾을 수 있습니다.
					</div>
					<div class="line"></div>
					<div class="choice">
						<span><img src="<?=G5_URL?>/img/idpw_ico.gif"></span>
						<div class="cl" style="margin:7px 0 0 0;font-size:14px;"><i>휴대폰 인증</i></div>
						<div class="cl" style="margin:15px 0 0 0;"><input type="radio" name="status" value="1" checked></div>
					</div>
					<div class="des1">
				...
				<li>
					...
					<div class="des">
						ㆍ회원 비밀번호의 경우 암호화 저장되어 분실시 찾아드릴 수 없는 정보입니다.</br>
					...
					<div class="input">
						<div style="margin:10px 0 0 0;">
							...
							<div style="margin:10px 0 0 0;"><input type="text" name="name" id="name" required class="frm_input" value="이름"></div>
							<div style="margin:-6px 0 0 0;"><input type="text" name="tel_no" id="tel_no" required class="frm_input" value="휴대폰번호"></div>
