...
?>
    <ul class="sanchor">
        <li style="border-left:0;width:20%;" <?php if ($anc_id == 'inf') echo 'class="sanchor_on"'; ?>><a href="#sit_inf">상품정보</a></li>
		<li style="width:20%;" <?php if ($anc_id == 'qa') echo 'class="sanchor_on"'; ?>><a href="#sit_qa">상품 Q & A <span class="item_qa_count"><?php// echo $item_qa_count; ?></span></a></li>
        <li style="width:20%;" <?php if ($anc_id == 'use') echo 'class="sanchor_on"'; ?>><a href="#sit_use">고객상품평 <span class="item_use_count"><?php// echo $item_use_count; ?></span></a></li>
        <?php if ($default['de_baesong_content']) { ?><li style="width:20%;" <?php if ($anc_id == 'dvr') echo 'class="sanchor_on"'; ?>><a href="#sit_dvr">배송안내</a></li><?php } ?>
		...
		<?php if ($default['de_change_content']) { ?><li style="border-right:0; width:20%" <?php if ($anc_id == 'ex') echo 'class="sanchor_on"'; ?>><a href="#sit_ex">오류신고</a></li><?php } ?>
    </ul>
<?php
}
?>
...
<div id="sit">
    ...
    // 상품 구입폼
	if($ca_name == "Auction"){
		include_once(G5_SHOP_SKIN_PATH.'/item.form.auction.skin.php');
	}else{
    ...
    // 상품 상세정보
	if($ca_name == "Auction"){
		include_once(G5_SHOP_SKIN_PATH.'/item.info.auction.skin.php');
	}else{
