...
<div style="background:#fff;">
	...
	<div id="my_ex_step">
		...
		<div><img src="<?=G5_URL?>/img/my_ex_step2_o.gif" border="0" align="absmiddle"></div>
	...
	<div id="my_ex_bn">
		<img src="<?=G5_URL?>/img/my_ex_submit1.gif" border="0" align="absmiddle" class="my_ex_submit">
...
$(document).ready(function(){
	$(".my_ex_submit").click(function(){
		if(confirm("교환요청을 하시겠습니까?")){
			$("form[name='fitemexchange']").attr("action", "./itemexchangeupdate.php").submit();
		}
	});
