...
<div style="background:#fff;">
	...
	<div id="my_ex_step">
		<div><img src="<?=G5_URL?>/img/my_ex_step1.gif" border="0" align="absmiddle"></div>
		<div><img src="<?=G5_URL?>/img/my_ex_step2.gif" border="0" align="absmiddle"></div>
		<div><img src="<?=G5_URL?>/img/my_ex_step3_o.gif" border="0" align="absmiddle"></div>
	</div>
	...
	<div id="my_ex_tb" style="margin:5px 0 0 0;border-top:2px #545454 solid;">
		<table border="0" cellspacing="0" cellpadding="0" width="100%">
			<tr height="60px">
				<td style="width:120px;text-align:center;font-size:16px;vertical-align:bottom;"><b>주문하신 상품이 <font color="#ff4e00">교환요청완료</font> 되었습니다.</b></td>
			</tr>
			<tr height="70px">
				<td style="text-align:center;font-size:11px;">교환진행 과정은 교환/반품 현황조회에서 조회가 가능합니다.</td>
			</tr>
		</table>
	</div>
