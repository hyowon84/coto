...
<div style="color:#223753;font-size:20px;font-weight:bold;">투데이스토어</div>
	...
	<table border="0" cellspacing="0" cellpadding="0" width="100%" class="my_deli_info_tb">
		...
		<tr>
			...
			<td style="text-align:center;width:80px;">
				<?=$row[od_status]?></br>
				<?if($row[od_status] == "배송준비중" || $row[od_status] == "해외배송중" || $row[od_status] == "배송중" || $row[od_status] == "배송완료"){?>
					<div class="my_deli_info_bn_com" od_id="<?=$row[od_id]?>" status="today" style="margin-top:3px;padding:2px 7px 2px 7px;border:1px #cfcfcf solid;font-size:9px;width:40px;text-align:center;margin:0 auto;cursor:pointer;">배송조회</div>
				<?}?>
			</td>
		</tr>
		<?
