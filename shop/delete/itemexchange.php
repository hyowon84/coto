...
<div style="background:#fff;">
	...
	<div id="my_ex_step">
		<div><img src="<?=G5_URL?>/img/my_ex_step1_o.gif" border="0" align="absmiddle"></div>
		<div><img src="<?=G5_URL?>/img/my_ex_step2.gif" border="0" align="absmiddle"></div>
		<div><img src="<?=G5_URL?>/img/my_ex_step3.gif" border="0" align="absmiddle"></div>
	</div>
		...
		<tr style="font-size:11px;">
			...
			<td>
				<table border="0" cellspacing="0" cellpadding="0" width="100%">
					<tr>
						<td style="border:0px;"><a href="<?=G5_SHOP_URL?>/grouppurchase.php?it_id=<?=$cart_row[it_id]?>"><?=$image?></a></td>
						<td style="border:0px;"><a href="<?=G5_SHOP_URL?>/grouppurchase.php?it_id=<?=$cart_row[it_id]?>"><?=$cart_row[it_name]?></a></td>
					</tr>
				</table>
			</td>
	...
	<div id="my_ex_tb">
		<table border="0" cellspacing="0" cellpadding="0">
			<tr height="40px">
				...
				<td>
					<select name="ex_status" style="border:1px #e5e5e5 solid;color:#737373;font-size:13px;">
			...
			<tr>
				...
				<td>
					<textarea name="ex_con" style="width:520px;height:85px;border:1px #e5e5e5 solid;"></textarea>
				</td>
			</tr>
		</table>
	</div>
	...
	<div id="my_ex_bn">
		<img src="<?=G5_URL?>/img/my_ex_submit.gif" border="0" align="absmiddle" class="my_ex_submit">
...
$(document).ready(function(){
	$(".my_ex_submit").click(function(){
		if($("select[name='ex_status']").val() == ""){
			alert("사유를 선택해주세요");
			$("select[name='ex_status']").focus();
			return false;
		}

		if($("textarea[name='ex_con']").val() == ""){
			alert("사유를 입력해주세요");
			$("textarea[name='ex_con']").focus();
			return false;
		}

		if(confirm("교환요청을 하시겠습니까?")){
			$("form[name='fitemexchange']").attr("action", "./itemexchange_addr_info.php").submit();
		}
	});
});
