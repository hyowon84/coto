...
<script>
    ...
    function  jsf__chk_tr_code( form )
    {
        ...
        else if (form.tr_code[2].checked )
        {
            span_tr_code_0.style.display = "none";
    ...
    <section>
        ...
        <div class="tbl_head01 tbl_wrap">
            ...
            <tr>
                ...
                <td>
					<input type="radio" name="tr_code" value="" onClick="jsf__chk_tr_code( this.form )" <?if($od['od_tax'] == ""){echo "checked";}?>>미발행&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="tr_code" value="0" onClick="jsf__chk_tr_code( this.form )" <?if($od['od_tax'] == "0"){echo "checked";}?>>소득공제용&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="tr_code" value="1" onClick="jsf__chk_tr_code( this.form )" <?if($od['od_tax'] == "1"){echo "checked";}?>>지출증빙용
                </td>
            </tr>
            <tr>
                <th scope="row">
                    <label for="id_info">
                        <span id="span_tr_code_0" style="display:<?if($od['od_tax'] == "0"){?>inline<?}else{?>none<?}?>">주민(휴대폰)번호</span>
                        <span id="span_tr_code_1" style="display:<?if($od['od_tax'] == "1"){?>inline<?}else{?>none<?}?>">사업자번호</span>
                    </label>
                </th>
                <td>
                    <input type="text" name="id_info" id="id_info" class="frm_input" style="display:<?if($od['od_tax'] == "0" || $od['od_tax'] == "1"){?>inline<?}else{?>none<?}?>;" size="16" maxlength="13" value="<?=$od['od_tax_hp']?>"> ("-" 생략)
                </td>
            </tr>
            <tr>
