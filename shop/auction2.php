...
?>
    <ul class="sanchor">
        ...
        <?php if ($default['de_baesong_content']) { ?><li <?php if ($anc_id == 'dvr') echo 'class="sanchor_on"'; ?>><a href="#sit_dvr">배송안내</a></li><?php } ?>
		...
		<?php if ($default['de_change_content']) { ?><li style="border-right:0;" <?php if ($anc_id == 'ex') echo 'class="sanchor_on"'; ?>><a href="#sit_ex">오류신고</a></li><?php } ?>
    </ul>
<?php
}
?>
...
<div id="sit">
    ...
    <?php
    // 상품 구입폼
    include_once(G5_SHOP_SKIN_PATH.'/delete/auction.form.skin.php');
    ?>

    <?php
    // 상품 상세정보
    include_once(G5_SHOP_SKIN_PATH.'/delete/auction.info.skin.php');
    ?>
