...
<div style="background:#fff;">
	...
	<div id="general_box">
		<table border="0" cellspacing="0" cellpadding="0" width="100%" height="80px">
			...
			<tr>
				<td class="des"><?=od_status_cnt_gp("상품준비중")?></td>
				<td class="des"><?=od_status_cnt_gp("결제완료")?></td>
				<td></td>
				<td class="des"><?=od_status_cnt_gp("상품준비중")?></td>
				<td class="des"><?=od_status_cnt_gp("배송중")?></td>
				<td class="des"><?=od_status_cnt_gp("배송완료")?></td>
			</tr>
		</table>
	</div>
...
$(document).ready(function(){
	...
	$(".ex_bn").click(function(){
		...
		$("form[name='forderinquiry']").attr("action", "./itemexchange_gp.php").submit();
	});
	...
	$(".re_bn").click(function(){
		...
		var od_id = $(this).attr("od_id");
		$("input[name='ex_bn_input["+idx+"]']").val(od_id);
		$("form[name='forderinquiry']").attr("action", "./itemreturn_gp.php").submit();
	});
