...
$itemuse_list = "./itemuselist_gp.php";
$itemuse_form = "./gpitemuseform.php?gp_id=".$gp_id;
$itemuse_formupdate = "./gpitemuseformupdate.php?gp_id=".$gp_id;

$sql_common = " from g5_shop_gpitem_use where gp_id = '{$gp_id}' ";
...
$itemuse_skin = G5_SHOP_SKIN_PATH.'/gpitemuse.skin.php';
