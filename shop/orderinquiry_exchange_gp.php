...
{
    $sql_common = " from {$g5['g5_shop_order_table']} as a LEFT JOIN {$g5['g5_shop_cart_table']} as b ON a.od_id=b.od_id where a.od_id = '$od_id' and a.od_pwd = '$od_pwd' ";
}
...
<div id="sod_v">
    ...
    include "./orderinquiry_exchange_gp.sub.php";
    ?>
