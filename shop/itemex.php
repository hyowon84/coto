...
if (G5_IS_MOBILE) {
    include_once(G5_MSHOP_PATH.'/itemex.php');
    return;
}
...
function itemex_page($write_pages, $cur_page, $total_page, $url, $add="")
{
...
$itemqa_list = "./itemexlist.php";
$itemqa_form = "./itemexform.php?it_id=".$it_id;
$itemqa_formupdate = "./itemexformupdate.php?it_id=".$it_id;

$sql_common = " from g5_shop_item_ex where it_id = '{$it_id}' ";
...
$itemex_skin = G5_SHOP_SKIN_PATH.'/itemex.skin.php';

if(!file_exists($itemex_skin)) {
    echo str_replace(G5_PATH.'/', '', $itemex_skin).' 스킨 파일이 존재하지 않습니다.';
} else {
    include_once($itemex_skin);
}
?>