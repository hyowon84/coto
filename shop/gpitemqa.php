...
$itemqa_list = "./gpitemqalist.php";
$itemqa_form = "./gpitemqaform.php?gp_id=".$gp_id;
$itemqa_formupdate = "./gpitemqaformupdate.php?gp_id=".$gp_id;

$sql_common = " from g5_shop_gpitem_qa where gp_id = '{$gp_id}' ";
...
$itemqa_skin = G5_SHOP_SKIN_PATH.'/gpitemqa.skin.php';
