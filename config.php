...
define('WEB_DOMAIN', 'http://coinstoday.co.kr/');
define('DEV_DOMAIN', '');
...
define('G5_IMG_MOBILE_DIR', 'img/m');
define('G5_JS_DIR',         'js');
...
define('G5_GOLDSPOT_DIR',		'goldspot');
define('G5_INC_DIR',     		'inc');
...
define('G5_IMG_MOBILE_URL',        G5_URL.'/'.G5_IMG_MOBILE_DIR);
...
define('G5_GOLDSPOT_URL',      G5_PLUGIN_URL.'/'.G5_GOLDSPOT_DIR);
...
define('G5_GOLDSPOT_PATH',      G5_PLUGIN_PATH.'/'.G5_GOLDSPOT_DIR);

define('G5_INC_PATH',       G5_PATH.'/'.G5_INC_DIR);
//==============================================================================
