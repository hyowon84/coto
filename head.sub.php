...
<noscript>
<link rel="stylesheet" type="text/css" href="<?=G5_URL?>/css/noscript.css" />
</noscript>
<link rel="stylesheet" type="text/css" href="<?=G5_URL?>/css/style.css" />
...
<script type="text/javascript" src="<?=G5_URL?>/js/jquery.sliderkit.1.8.min.js"></script>	

<?php if (defined('_SHOP_')) { ?>
	<script src="<?=G5_JS_URL?>/jquery.shop.menu.js"></script>
<?php } else { ?>
...
<script src="<?=G5_URL?>/menu.js"></script>
...
<script type="text/javascript" src="<?=G5_URL?>/js/common_order.js"></script>
...
<?
if(!defined('G5_IS_ADMIN')) include_once(G5_PATH.'/analyticstracking.php');
