...
if($w==""){
	...
	if($_POST[ebay_gubun]=="경매")$purchaseShoppingGubun = "A";
	else $purchaseShoppingGubun = "N";
}
...
<input type="hidden" name="od_site" id="od_site" value="ebay.com">
					...
					<td>
						<table>
							...
							<tr>
								...
								<td><input type="text" name="pc_item[]" id="pc_item_<?php echo $seq; ?>" value="<?php echo $_POST[ebay_title]; ?>" class="frm_input" size="65"></td>
							</tr>

							 <tr>
								<th scope="row"><label for="pc_item_url_<?php echo $seq; ?>">상품주소 URL</label></th>
								<td><input type="text" name="pc_item_url[]" id="pc_item_url_<?php echo $seq; ?>" value="<?php echo $_POST[ebay_link]; ?>" class="frm_input" size="65"></td>
							</tr>

							<tr>
								<th scope="row"><label for="pc_item_option_<?php echo $seq; ?>">상품옵션</label></th>
								<td><input type="text" name="pc_item_option[]" id="pc_item_option_<?php echo $seq; ?>" value="<?php echo $spl_subject[$i]; ?>" class="frm_input" size="65"></td>
							</tr>

						
							 <tr>
								<th scope="row"><label for="pc_type_<?php echo $seq; ?>">구입방식</label></th>
								<td><?php echo getSelectArrayList($purchaseShoppingType,"pc_type[]","pc_type_".$seq,$purchaseShoppingGubun," onchange=\"pc_type_chgmsg('".$seq."',this.value);\"");?></td>
							</tr>


							 <tr>
								<th scope="row"><label for="pc_price_<?php echo $seq; ?>">상품가격</label></th>
								<td>USD <input type="text" name="pc_price[]" id="pc_price_<?php echo $seq; ?>" value="<?php echo $_POST[ebay_price]; ?>" class="frm_input" size="10"><span id="pc_price_msg_<?php echo $seq; ?>"></span></td>
							</tr>
							<input type="hidden" name="pc_price1[]" id="pc_price1_<?php echo $seq; ?>" value="<?php echo $_POST[ebay_price1]; ?>">
...
$(document).ready(function(){
	<?php if($purchaseShoppingGubun=="A"){?>
		pc_type_chgmsg(1,'A')
	<?php }?>
});
