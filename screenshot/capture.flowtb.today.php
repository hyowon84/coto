...
$modelist = Array('SL_UP_B','SL_DOWN_B','GL_UP_B','GL_DOWN_B');
...
/*비교할 날짜*/
$cmpdate = date("Y-m-d",strtotime("-1 day"));

for($i = 0; $i < count($modelist); $i++) {
	$mode = $modelist[$i];
	
	$CAPTURE_URL = "http://coinstoday.co.kr/chart/flow_tb.php?mode=".$mode."&date=".$date."&cmpdate=".$cmpdate;
	$javascript_filename = "./js/".$ymd."_flowtb_today_".$mode.".js";
	$screenshot_filename = "./img/".$ymd."_flowtb_today_".$mode.".jpg";
