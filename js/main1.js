...
(function ($) {
	...
	var $window = $(window),
		...
		// scrollpanel1
		// ===========
		scrollpanel1 = function (element, options) {
		...
		// scrollpanel1 methods
		// ===================
		$.extend(scrollpanel1.prototype, {
	...
	$.fn[name] = function (options, options2) {
		...
		return this.each(function () {
			...
			var $this = $(this),
				scrollpanel1 = $this.data(name);

			if (!scrollpanel1) {
				scrollpanel1 = new scrollpanel1(this, options);
				scrollpanel1.update();
				$this.data(name, scrollpanel1);
			}

			if (options === 'update') {
				scrollpanel1.update(options2);
			}
		});
	};
...
(function($) {
	...
	var generateContent = function () {
		...
		updateContent = function () {
			...
			$panel.scrollpanel1('update');
		},

		init = function () {

			generateContent();
			$('.scrollpanel1').scrollpanel1();
