...
//            });
            ...
            var htmlMarkup = [
                ...
                '<html class="' + Ext.baseCSSPrefix + 'ux-grid-printer">',
                  ...
                  '<table border=0>',
                		'<tr>',
                			'<td valign="bottom" style="font-size:1.5em; font-weight:bold;">' + this.mainTitle + '</td>',
                			'<td><div style="width:auto; font-size:1.2em; padding:10px; border:1px solid; text-align:left;">' + this.tag + '</div></td>',
                		'</tr>',
                	'</table>',
                    '<table>',
                      '<tr>',
